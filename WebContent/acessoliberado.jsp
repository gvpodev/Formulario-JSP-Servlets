...
<link rel="stylesheet" href="resources/css/bemvindo.css">
</head>
<body>
	<div class="container">
		...
		<table>
			<tr>
				<td><a href="salvarUsuario?acao=listartodos"> <img
						...
						src="resources/img/registrar.png" width="100px" height="100px"></a></td>
				<td><a href="salvarProduto?acao=listartodos"><img
						alt="Cadastro de produto" title="Cadastro de produto"
						src="resources/img/produtos10.png" width="100px" height="100px"></a></td>
			</tr>
		</table>
	</div>
</body>
